...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        jshn kmod-brcmfmac kmod-brcmutil kmod-cfg80211 kmod-mac80211 kmod-ath9k-htc ath9k-htc-firmware kmod-rtl8188eu r8188eu-firmware kmod-rtl8189fs kmod-rtl8189es libjson-script liblucihttp \
